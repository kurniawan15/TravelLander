...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"USERNAME\" placeholder=\"Username\" style=\"text-align: left; font-size: 14px;\">\r\n");
      ...
      out.write("\t\t\t\t\t  <form action=\"traveller?data=traveller&proses=input-traveller\" method=\"post\"\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"NAMA_TRAVELLER\" placeholder=\"Fullname\"  style=\"text-align: left; font-size: 14px;\">\r\n");
      out.write("\t\t\t\t\t  \t<input type=\"text\" name=\"EMAIL\" placeholder=\"Email\" style=\"text-align: left; font-size: 14px;\">\r\n");
      out.write("\t\t\t\t\t  \t<input type=\"text\" name=\"USERNAME\" placeholder=\"Username\" style=\"text-align: left; font-size: 14px;\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"password\" name=\"PASSWORD\" placeholder=\"Password\">\r\n");
