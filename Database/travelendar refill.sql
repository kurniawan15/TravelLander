...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2017 at 09:59 AM
...
CREATE TABLE IF NOT EXISTS `event` (
  ...
  KEY `Kd_Traveller` (`Kd_Traveller`),
  KEY `Id_Pejalanan` (`Kd_Perjalanan`)
...
CREATE TABLE IF NOT EXISTS `jarak` (
  ...
  PRIMARY KEY (`Kd_jarak`),
  KEY `Kd_lokasi_awal` (`Kd_lokasi_awal`),
  KEY `Kd_lokasi_akhir` (`Kd_lokasi_akhir`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
CREATE TABLE IF NOT EXISTS `list_jarak` (
`Kd_Jarak` varchar(14)
...
--
CREATE TABLE IF NOT EXISTS `list_perjalanan` (
...
('KL00052', 'Rumah', 'Maleber, Karang Tengah, Cianjur', 'KT005', 'JB'),
('KL00053', 'Hotel Amarossa Bandung', 'Jl. Aceh No. 71 A, Citarum, Bandung Wetan', 'KT005', 'JB'),
('KL00054', 'SMAN 20 BANDUNG', 'Jalan Citarum No.23, Citarum, Bandung', 'KT005', 'JB'),
('KL00055', 'R.M Ampera Bandung', 'Jl. Citarum No.3A, Citarum, Bandung', 'KT005', 'JB'),
('KL00056', 'Bandara Hussein Satra Negara', 'Jl. Pajajaran No. 156, Cicendo, Kota Bandung', 'KT005', 'JB'),
('KL00057', 'Bandara Juanda Surabaya', 'Jl. Raya Ir. Juanda No.1, Sedati, Sidoarjo, Jawa Timur', 'KT084', 'JI'),
('KL00058', 'BEBEK HANDAYANI SURABAYA', 'Jl. Dukuh Menanggal Sel. No.103 Kota SBY', 'KT084', 'JI'),
('KL00059', 'SMAN 15 surabaya', 'Jl. Parang Kusumo No.2-I, Kemayoran,  Surabaya', 'KT084', 'JI'),
('KL00060', 'DINAS PENDIDIKAN KAB. CIANJUR', 'Jl. Perintis Kemerdekaan No. 3, Cilaku, Kabupaten Cianjur', 'KT099', 'JB');
...
CREATE TABLE IF NOT EXISTS `moda_transportasi` (
...
CREATE TABLE IF NOT EXISTS `perjalanan` (
  ...
  KEY `Kd_jarak` (`Kd_jarak`),
  KEY `Kd_Transportasi_Pribadi` (`Kd_Transportasi_Pribadi`),
  KEY `Kd_Transportasi_Publik` (`Kd_Transportasi_Publik`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `transportasi_pribadi`
--

CREATE TABLE IF NOT EXISTS `transportasi_pribadi` (
  `Kd_Transportasi_Pribadi` varchar(6) NOT NULL,
  `Kd_Moda` varchar(6) NOT NULL,
  `Nama_Transportasi_Pribadi` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`Kd_Transportasi_Pribadi`),
  KEY `Kd_Moda` (`Kd_Moda`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `transportasi_pribadi`
--
...
CREATE TABLE IF NOT EXISTS `transportasi_publik` (
  ...
  PRIMARY KEY (`Kd_Transportasi_Publik`),
  KEY `Kd_Moda` (`Kd_Moda`),
  KEY `Kd_lokasi_kedatangan` (`Kd_lokasi_kedatangan`),
  KEY `Kd_lokasi_keberangkatan` (`Kd_lokasi_keberangkatan`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `transportasi_publik`
--
...
('TU0006', 'KMT01', 'Kereta Api', NULL, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
--
-- Structure for view `list_perjalanan`
--
...
--
-- Constraints for table `transportasi_pribadi`
--
...
--
-- Constraints for table `transportasi_publik`
--
